    ...
    <form onSubmit={handleSubmit} className="flex flex-col space-y-4 bg-white p-6 rounded-lg shadow-lg">
      ...
      <div className="formItem">
        ...
        <input type="text" name="name" id="name" placeholder="Name*" required
          className="w-full px-4 py-2 bg-white border border-black rounded-md shadow-sm focus:outline-none focus:ring-emerald-800 focus:border-emerald-800" />
      </div>
      ...
      <div className="formItem">
        ...
        <input type="email" name="email" id="email" placeholder="Email*" required
          className="w-full px-4 py-2 bg-white border border-black rounded-md shadow-sm focus:outline-none focus:ring-emerald-800 focus:border-text-box" />
      ...
      <div className="formItem">
        ...
        <textarea name="message" id="message" rows={5} placeholder="Message*" required
          className="w-full p-4 bg-white border border-black rounded-md shadow-sm focus:outline-none focus:ring-emerald-800 focus:border-emerald-800"></textarea>
        <ValidationError prefix="Message" field="message" errors={state.errors} className="text-red-500" />
      </div>

      <button type="submit" disabled={state.submitting} className="text-box py-2 px-4 bg-emerald-800 text-white rounded-md shadow-lg hover:bg-emerald-700 focus:outline-none focus:ring-2 focus:ring-emerald-200 focus:ring-opacity-50">
        Send Message
      </button>
    </form>
  );
